...
def router_node(state: PipelineState) -> dict:
    ...
    if config.SESSION_CACHE_ENABLED:
        ...
        if cached:
            ...
            return {
                ...
                "subqueries": cached.get("subqueries") or [cached.get("rewritten_query") or raw_query],
    ...
    try:
            ...
            router_cache_update = {
                **existing_cache,
                cache_key: {
                    ...
                    "subqueries": list(router_result.subqueries),
        ...
        return {
            ...
            "recursive_search": router_result.recursive_search,
            "requires_retrieval": router_result.requires_retrieval,
            "dropped_course_ids": list(router_result.dropped_course_ids),
            "repairs_applied": list(router_result.repairs_applied),
